...
% MANCANO SU SITO NUMERI PAGINE - aggiornali appena puoi
...
% Titolo sicuramente da modificare, ora e' un survey
...
% \item{\bf A. Raffo, L. Gagliardi, U. Fugacci, S. Biasotti, W. Rocchia, et al.} {\em SHREC 2022: Protein-Ligand Binding Site Recognition}. In preparation.

% \item{\bf U. Fugacci, C. Landi, H. Varl{\i}.} {\em PL and Discrete Morse-Smale Complexes}. In preparation.

% \item{\bf A. Raffo, U. Fugacci, S. Biasotti, G. Luciano} {\em Re-CAST}. In preparation.

% \item{\bf A. Raffo, L. Gagliardi, U. Fugacci, S. Biasotti, W. Rocchia} {\em Chanalizer}. In preparation.
...
% \item Scaramuccia & Fontana?

% \item Topological Correlation of Functions
...
% \item {TALK PER PETRI????Direi di no perche' non e' internazionale.}.
% % coronavirus
...
% \item {TALK ALGEBRA E GEOMETRIA????Direi di no perche' non e' internazionale.}.
...
% \item CORSO CONCA.
% \item SEMINARI IMATI A MATEMATICA.
\end{itemize}
...
\begin{itemize}
  ...
  \item Co-advisor for Master Thesis in Mathematics by Gianluca Zanetti, co-advised with Prof. G. Ruffo and Dr. S. Scaramuccia, April 2022 (expected).
\end{itemize}
